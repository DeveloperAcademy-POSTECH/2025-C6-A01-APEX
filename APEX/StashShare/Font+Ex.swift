...
//  StashShare
//
//  Copied from app to ensure identical typography in the Share Extension.
//
...
extension Font {
    ...
    static var caption1: Font { .pretandard(.semibold, size: 12) }
    static var caption2: Font { .pretandard(.medium, size: 12) }
